...
$allowed = [
  ...
  'grooming','petshop',
  'farmacia','inventario',
  'facturacion','reenvio_sunat','plantillas','caja','personal','reportes',
...
// 'reenvio_sunat' valida admin + canView('facturacion') internamente.
$modulos_sin_permiso = ['portal','buscar','evolucion','whatsapp_conexion','reenvio_sunat'];
